...
- **驻留菜单栏**：不占 Dock、不进 ⌘Tab；关掉设置窗口也不退出，点菜单栏图标可重新打开（想回 Dock 就把这个开关关掉）
- **新建文件**：17 种文件类型（纯文本 / Markdown / Word / Excel / PPT / WPS / Pages / PSD …），可增删、可拖拽排序，**顺序就是右键菜单顺序**
...
![通用设置面板](docs/settings-general.png)
